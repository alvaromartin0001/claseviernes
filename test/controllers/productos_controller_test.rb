...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { codigo: @producto.codigo, name: @producto.name, valor: @producto.valor } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { codigo: @producto.codigo, name: @producto.name, valor: @producto.valor } }
